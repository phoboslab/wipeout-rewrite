...
void game_init(void) {
	...
	input_bind(INPUT_LAYER_SYSTEM, INPUT_KEY_W, A_MENU_UP_2);
	input_bind(INPUT_LAYER_SYSTEM, INPUT_KEY_S, A_MENU_DOWN_2);
	input_bind(INPUT_LAYER_SYSTEM, INPUT_KEY_A, A_MENU_LEFT_2);
	input_bind(INPUT_LAYER_SYSTEM, INPUT_KEY_D, A_MENU_RIGHT_2);

	input_bind(INPUT_LAYER_SYSTEM, INPUT_KEY_K, A_MENU_UP_3);
	input_bind(INPUT_LAYER_SYSTEM, INPUT_KEY_J, A_MENU_DOWN_3);
	input_bind(INPUT_LAYER_SYSTEM, INPUT_KEY_H, A_MENU_LEFT_3);
	input_bind(INPUT_LAYER_SYSTEM, INPUT_KEY_L, A_MENU_RIGHT_3);
